...
@Module({
  imports: [PrismaModule, AuthModule, EstoqueModule, ComprasModule, CotacoesModule, FinanceiroModule, IntegracoesModule, FornecedoresModule, FuncionariosModule, UsuariosModule, ReceitasModule],
